...
class FabricanteVehiculoController extends Controller {
	...
	public function update(Request $request, $idFabricante, $idVehiculo)
	{
		...
		if (!$vehiculo) 
		{
			return response()->json(['Mensaje' => 'NO se encuentra este vehiculo asociado a este fabricante', 'Codigo' => 404],404);
		}
	...
	public function destroy($idFabricante, $idVehiculo)
	{
		...
		return response()->json(['mensaje'=>'Vehiulo Eliminado'],200);
	}
